...
function buildGraphs(euCrimeStats){
    ...
    var irelandRobberyGrp = dateDim.group().reduceSum(function(d){
    ...
    var englandRobberyGrp = dateDim.group().reduceSum(function(d){
    ...
    var scotlandRobberyGrp = dateDim.group().reduceSum(function(d){
    ...
    var walesRobberyGrp = dateDim.group().reduceSum(function(d){
    ...
    var northernIrelandRobberyGrp = dateDim.group().reduceSum(function(d){
    ...
    var restOfUKRobberyGrp = dateDim.group().reduceSum(function(d){
    ...
    crimeLineChartIreland
        ...
        .height(300)
        .dimension(dateDim)
        .group(irelandRobberyGrp,"Ireland")
        //.dashStyle([1,1])
        .renderArea(true)
    ...
    crimeLineChartEngland
        ...
        .height(300)
        .dimension(dateDim)
        .group(englandRobberyGrp,"England")
    ...
    crimeLineChartScotland
        ...
        .height(300)
        .dimension(dateDim)
        .group(scotlandRobberyGrp,"Scotland")
        //.dashStyle([3,3])
        .renderArea(true)
        .x(d3.time.scale().domain([minDate,maxDate]))
        .yAxisLabel('Assaults')
    ...
    crimeLineChartNorthernIreland
        ...
        .height(300)
        .dimension(dateDim)
        .group(northernIrelandRobberyGrp,"Northern Ireland")
        //.dashStyle([5,5])
        .renderArea(true)
        .x(d3.time.scale().domain([minDate,maxDate]))
        .yAxisLabel('Assaults')
    ...
    crimeLineChartRestOfUk
        ...
        .height(300)
        .dimension(dateDim)
        .group(restOfUKRobberyGrp,"Scotland,Wales,N.I.")
        //.dashStyle([5,5])
        .renderArea(true)
        .x(d3.time.scale().domain([minDate,maxDate]))
        .yAxisLabel('Assaults')
