...
function buildGraphs(euCrimeStats){
    ...
    var irelandSAGrp = dateDim.group().reduceSum(function(d){
    ...
    var englandSAGrp = dateDim.group().reduceSum(function(d){
    ...
    var scotlandSAGrp = dateDim.group().reduceSum(function(d){
    ...
    var walesSAGrp = dateDim.group().reduceSum(function(d){
    ...
    var northernIrelandSAGrp = dateDim.group().reduceSum(function(d){
    ...
    var restOfUKSAGrp = dateDim.group().reduceSum(function(d){
    ...
    crimeLineChartNorthernIreland
        ...
        .height(300)
        .dimension(dateDim)
        .group(northernIrelandSAGrp,"Northern Ireland")
        //.dashStyle([5,5])
        .renderArea(true)
        .x(d3.time.scale().domain([minDate,maxDate]))
        .yAxisLabel('Assaults')
    ...
    crimeLineChartRestOfUk
        ...
        .height(300)
        .dimension(dateDim)
        .group(restOfUKSAGrp,"Scotland,Wales,N.I.")
        //.dashStyle([5,5])
        .renderArea(true)
        .x(d3.time.scale().domain([minDate,maxDate]))
        .yAxisLabel('Assaults')
